...
| Sleep player/timer | IN PROGRESS / CONTENT + DISCOVERY + QA | Existing looping Sound playback/timer behaviour remains tested, including delayed-start cancellation, media-notification intent and volume restoration after interrupted expiry. The canonical Stories / Nature / Meditations / Sleep Music registry, local long-form progress, finite playback and parameterized Story player are implemented on the existing AudioService path. Public registry-driven discovery, approved production Story assets and physical background/interruption/long-duration QA remain open. Nature and Sleep Music stay narration-free; Stories and guided Sleep Meditations may use approved narration. |
