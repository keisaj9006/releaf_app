  ...
  void paint(Canvas canvas, Size size) {
    ...
    final halo = Paint()
      ..shader = RadialGradient(
        colors: [
          ReleafColors.sage.withValues(alpha: 0.10 + (0.08 * e)),
    ...
    Path lobe(bool left) {
      ...
      return Path()
        ..moveTo(size.width * (0.50 + d * 0.025), size.height * 0.28)
        ..cubicTo(
          size.width * (0.50 + d * 0.13),
          size.height * 0.25,
          size.width * (0.50 + d * 0.31),
          size.height * 0.34,
          size.width * (0.50 + d * 0.33),
          size.height * 0.54,
        )
        ..cubicTo(
          size.width * (0.50 + d * 0.34),
          size.height * 0.72,
          size.width * (0.50 + d * 0.19),
          size.height * 0.83,
          size.width * (0.50 + d * 0.055),
          size.height * 0.77,
        )
        ..cubicTo(
          size.width * (0.50 + d * 0.02),
          size.height * 0.67,
          size.width * (0.50 + d * 0.018),
          size.height * 0.40,
          size.width * (0.50 + d * 0.025),
          size.height * 0.28,
        )
        ..close();
    }
    ...
    final fill = Paint()
      ..shader = LinearGradient(
        ...
        colors: [
          ReleafColors.sage.withValues(alpha: 0.25 + (0.08 * e)),
    ...
    final outline = Paint()
      ...
      ..strokeWidth = math.max(1.7, size.shortestSide * 0.010)
      ..strokeCap = StrokeCap.round
      ..strokeJoin = StrokeJoin.round;
    final vein = Paint()
      ..color = ReleafColors.sage.withValues(alpha: 0.26 + (0.12 * e))
      ..style = PaintingStyle.stroke
      ..strokeWidth = math.max(1.0, size.shortestSide * 0.006)
      ..strokeCap = StrokeCap.round;
    ...
    final airway = Paint()
      ...
      ..style = PaintingStyle.stroke
      ..strokeWidth = math.max(1.8, size.shortestSide * 0.011)
      ..strokeCap = StrokeCap.round;
    canvas.drawPath(
      Path()
