...
ReleafArtworkVariant _sessionArtwork(ResetContent session) {
  return switch (session.id) {
    ...
    'cool-water-reset' => ReleafArtworkVariant.grounding,
    'pushups-activation' => ReleafArtworkVariant.lifeUpgrade,
    'shoulder-drop-reset' => ReleafArtworkVariant.noBreath,
    'eye-focus-reset' => ReleafArtworkVariant.focus,
    'shake-it-out' => ReleafArtworkVariant.noBreath,
    'micro-walk-reset' => ReleafArtworkVariant.grounding,
    'one-small-next-step' => ReleafArtworkVariant.lifeUpgrade,
    'sleep-faster-routine' => ReleafArtworkVariant.ambient,
    'morning-reset-ritual' => ReleafArtworkVariant.lifeUpgrade,
    'confidence-posture-reset' => ReleafArtworkVariant.grounding,
    'deep-focus-method' => ReleafArtworkVariant.focus,
    'emotional-stability-drill' => ReleafArtworkVariant.calm,
    'night-nervous-system-unwind' => ReleafArtworkVariant.ambient,
    'quick-mood-shift' => ReleafArtworkVariant.lifeUpgrade,
    'body-recalibration' => ReleafArtworkVariant.grounding,
    'equal-rhythm' => ReleafArtworkVariant.breath,
    'box-breathing' => ReleafArtworkVariant.focus,
    'sleep-downshift' => ReleafArtworkVariant.ambient,
    'energy-up-breath' => ReleafArtworkVariant.lifeUpgrade,
    'focus-breath' => ReleafArtworkVariant.focus,
    'anxiety-slow-cycle' => ReleafArtworkVariant.calm,
